...
import login.Login;
import opp.tof.AdminPage1;
import opp.tof.KasirPage;
import opp.tof.OwnerPage;
...
public class ProfilePage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bt_logout.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/img/Change User.png"))); // NOI18N
        ...
        pn_utama.setBackground(new java.awt.Color(255, 204, 0));

        data_produk.setBackground(new java.awt.Color(255, 153, 51));
    ...
    if (CurrentUser.getLevel() != null) {
        ...
        if (CurrentUser.getLevel().equals("admin")) {
            ...
            OwnerPage kasirPage = new OwnerPage();
            kasirPage.setVisible(true);
            this.dispose();
        } else {
