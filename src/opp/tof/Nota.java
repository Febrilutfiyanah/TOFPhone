...
public class Nota extends JDialog {
    ...
    private void generateNota() {
        ...
        for (int i = 0; i < model.getRowCount(); i++) {
            ...
            Object priceObj = model.getValueAt(i, 3);  // Ambil nilai harga sebagai Object
            
            // Cek apakah priceObj adalah Integer atau Double, kemudian konversikan ke Double
            double price = 0.0;
            if (priceObj instanceof Integer) {
                price = ((Integer) priceObj).doubleValue();  // Jika Integer, ubah ke Double
            } else if (priceObj instanceof Double) {
                price = (Double) priceObj;  // Jika Double, ambil langsung
            }
